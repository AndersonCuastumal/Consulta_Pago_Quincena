...
public class PagoQuincena {
    public static void main(String[] args) throws Exception {
        msgImprimir("Agregar fecha en el formato yyyy-mm-dd: ");
        Scanner scan=new Scanner(System.in);//fecha ingresada por usuario
        String dateInput=scan.next();
        
                
        //Imprimimos la fecha de pago de la quincena
        try{
            LocalDate date=LocalDate.parse(dateInput);// Parseamos la fecha
